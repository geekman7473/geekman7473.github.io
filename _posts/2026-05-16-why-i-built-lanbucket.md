...
Since LANBucket is built on top of BitTorrent it is natural to ask why you should use LANBucket instead of a traditional torrenting client. The answer is simplicity. Where full-featured torrenting clients like [qBittorent](https://www.qbittorrent.org/) or [Tixati](https://tixati.com/) present the user with an enourmous ability for customization and tweaking, LANBucket intentionally hides almost all of the complexity from the user. LANBucket also solves the bootstrapping problem better than traditional torrent clients. If you and your users were all using qBittorrent for example, you would still need a second tool to somehow communicate to your users the magnet links for the torrents you want them to download.
